...
#define PRE_CAL_IMAGE_INFO_SIZE			16
#define CAL_BIN_OFFSET				0
...
#define PRE_CAL_BIN_OFFSET	 (CAL_BIN_OFFSET + PRE_CAL_IMAGE_INFO_SIZE)
#define DPD_BIN_OFFSET       (PRE_CAL_BIN_OFFSET + PRE_CAL_TOTAL_SIZE)
